...
![Conceptual diagram of simple linear regression showing the relationship between predictor X and response Y with the linear model equation](../images/images_4b.008.jpeg){#fig-regression-concept fig-align="center"}
...
![Historical illustration of Galton's regression to the mean, showing how offspring heights regress toward the population mean](../images/images_4b.002.jpeg){#fig-galton-regression fig-align="center"}
...
![Illustration of ordinary least squares showing how the regression line minimizes the sum of squared vertical distances (residuals) from points to the line](../images/images_4b.009.jpeg){#fig-ols-concept fig-align="center"}
...
![Hypothesis testing in regression showing the t-distribution for testing whether the slope coefficient differs from zero](../images/images_4b.011.jpeg){#fig-hypothesis-test fig-align="center"}
