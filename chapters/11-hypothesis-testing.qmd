...
![Type I and Type II errors in hypothesis testing](../images/week_3.007.jpeg){#fig-error-types fig-align="center"}
...
![The significance level α determines the rejection region for hypothesis testing](../images/week_3.008.jpeg){#fig-significance-level fig-align="center"}
...
![Test statistics follow known distributions under the null hypothesis](../images/week_3.001.jpeg){#fig-test-statistic fig-align="center"}
...
![One-tailed vs. two-tailed tests: the alternative hypothesis determines which tail(s) to consider](../images/week_3.002.jpeg){#fig-tailed-tests fig-align="center"}
...
![Randomization tests provide a distribution-free alternative to parametric tests](../images/week_3.009.jpeg){#fig-randomization-concept fig-align="center"}
